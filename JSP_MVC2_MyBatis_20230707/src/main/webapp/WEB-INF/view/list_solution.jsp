...
<body>
  ...
  <table width="1000" align="center" border="1" cellpadding="5" cellspacing="0">
    ...
    <tr>
      <td>
        <button type="button" onclick="addDummy(10)">더미 10개 추가</button>
        <button type="button" onclick="addDummy(100)">더미 100개 추가</button>
      </td>
      <td colspan="5" align="right">
        <input type="button" value="글쓰기" style="font-size: 13px;" onclick="location.href='insert.nhn'"/>
      </td>
    </tr>
  </table>
  <script>
