...
public class BookDTO {
  ...
  public BookDTO(int book_id, String book_kind, String book_title, int book_price, int book_count,
      String author, String publishing_com, String publishing_date, String book_image,
      String book_content, int discount_rate, String reg_date) {
  ...
  public String toString() {
    return "BookDTO {\"book_id\": \"" + book_id + "\", \"book_kind\": \"" + book_kind
        + "\", \"book_title\": \"" + book_title + "\", \"book_price\": \"" + book_price
        + "\", \"book_count\": \"" + book_count + "\", \"author\": \"" + author
        + "\", \"publishing_com\": \"" + publishing_com + "\", \"publishing_date\": \""
        + publishing_date + "\", \"book_image\": \"" + book_image + "\", \"book_content\": \""
        + book_content + "\", \"discount_rate\": \"" + discount_rate + "\", \"reg_date\": \""
        + reg_date + "\"}";
  }
}
