...
ALTER TABLE board
    ...
    MODIFY COLUMN re_step INT,
    MODIFY COLUMN re_level INT,
    MODIFY COLUMN readcount INT COMMENT '조회수',
    MODIFY COLUMN content VARCHAR(4096) COMMENT '내용'
;

INSERT INTO board(writer, email, subject, `password`, reg_date, `ref`, re_step, re_level, readcount, content) VALUES
('관리자', 'admin@example.com', '관리자입니다', 'admin', '2023-06-30', 0, 0, 0, 1, '누구나 자유롭게 글을 쓰시면서 놀 수 있습니다~')
;
