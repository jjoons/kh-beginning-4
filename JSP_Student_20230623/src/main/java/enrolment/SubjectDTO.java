...
public class SubjectDTO {
  ...
  public SubjectDTO(int subjectNum, String subjectName, String professorName, int hakjom,
      String major, String room, String subjectPurpos, String subjectGoal, String subjectTest,
  ...
  public String toString() {
    return "SubjectDTO [subjectNum=" + subjectNum + ", subjectName=" + subjectName
        + ", professorName=" + professorName + ", hakjom=" + hakjom + ", major=" + major + ", room="
        + room + ", subjectPurpos=" + subjectPurpos + ", subjectGoal=" + subjectGoal
        + ", subjectTest=" + subjectTest + ", grade=" + grade + ", studentCount=" + studentCount
        + "]";
  }
}
