...
public class CarReserve {
  ...
  public CarReserve(int reserve_seq, int no, String id, int qty, int dday, String rday, int usein,
  ...
  public String toString() {
    return "CarReserve [reserve_seq=" + reserve_seq + ", no=" + no + ", id=" + id + ", qty=" + qty
        + ", dday=" + dday + ", rday=" + rday + ", usein=" + usein + ", usewifi=" + usewifi
        + ", usenavi=" + usenavi + ", useseat=" + useseat + "]";
  }
}
