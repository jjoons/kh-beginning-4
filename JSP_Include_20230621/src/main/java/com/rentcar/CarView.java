...
public class CarView {
  ...
  public CarView(String name, int price, String img, int qty, int dday, String rday, int usein,
      int usewifi, int useseat, int usenavi) {
    this.name = name;
    this.price = price;
    this.img = img;
    this.qty = qty;
  ...
  public String toString() {
    return "CarView [name=" + name + ", price=" + price + ", img=" + img + ", qty=" + qty
