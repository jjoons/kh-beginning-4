...
<body>
  ...
  <%
      ...
      list = RentCarDAO.getInstance().getAllReserve(id);
    }
  %>
  <div align="center">
    <table>
      ...
      %>
          ...
          <td height="70" align="center">
            <img src="imgCar/<%=temp.getImg() %>"  width="120" height="70">
          </td>
          ...
          <td width="90" align="center">
            <button onclick="location.href='15_carReserveDel.jsp?id=<%= id %>&rday=<%= temp.getRday() %>'">삭제</button>
          </td>
        </tr>
      <%
        }
