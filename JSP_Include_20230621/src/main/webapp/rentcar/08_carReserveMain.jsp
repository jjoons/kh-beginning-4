...
<body>
  ...
  <div align="center">
      ...
      <tr height="240">
        ...
        %>
            <td width="333" align="center">
              <a href="01_main.jsp?center=10_carReserveInfo.jsp%3Fno%3D<%= bean.getNo() %>">
                <img alt="" src="imgCar/<%= bean.getImg() %>" width="300" height="220" />
              </a>
    ...
    <!-- 전체 검색을 눌렀을 때 -->
    <button onclick="location.href = '01_main.jsp?center=09_carAllList.jsp'">전체 검색</button>
  </div>
