...
<body>
  ...
  <div align="center">
    ...
    <form action="12_updateBoardSize.jsp" method="GET">
      <table border="1">
        <tr>
          <td colspan="3">
            한 페이지에 보여줄 게시글 수
        ...
        <tr>
          <td colspan="3"><a href="01_index.jsp">메인으로</a></td>
        </tr>
        <tr>
          <td colspan="3"><a href="10_dummySave.jsp">dummy 10개 추가하기</a></td>
        </tr>
        <tr>
          <td colspan="3"><a href="11_boardClear.jsp">전체 게시글 삭제</a></td>
        </tr>
        <tr>
          <td colspan="3" align="right"><a href="02_boardWrite.jsp">새 글쓰기</a></td>
        </tr>
        <tr>
          <td>번호</td>
          <td>작성자</td>
        ...
        %>
            <tr>
              ...
              <td>
                <a href="05_boardInfo.jsp?num=<%= board.getNum() %>"><%= board.getSubject() %></a>
              </td>
            </tr>
        <% } %>
      </table>
